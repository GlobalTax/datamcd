...
-- Enable RLS on profit_loss_data table
...
-- Enable RLS on profit_loss_templates table
...
-- Fix 3: Improve security definer functions
...
-- Fix 4: Enhance user deletion validation
