...
import { PayrollView } from '@/components/employees/PayrollView';
import { Card, CardContent } from '@/components/ui/card';
import { Receipt } from 'lucide-react';
import { ImpersonationBanner } from '@/components/ImpersonationBanner';

/**
 * Página de gestión de nómina para un restaurante específico
 */
const RestaurantPayrollPage: React.FC = () => {
            ...
            <div className="flex-1 flex items-center justify-center">
              <Card className="max-w-md">
                <CardContent className="text-center py-12">
                  <Receipt className="w-16 h-16 mx-auto mb-4 text-red-400" />
        ...
        <SidebarInset className="flex-1">
          ...
          <header className="flex h-16 shrink-0 items-center gap-2 border-b bg-white px-6">
            ...
            <div className="flex-1">
              <h1 className="text-lg font-semibold text-gray-900">Gestión de Nómina</h1>
...
export default RestaurantPayrollPage;